...
def fast_closest_pair(cluster_list):
    ...
    def fast_helper(cluster_list, horiz_order, vert_order):
        ...
        # divide        
            ...
            mid_points = numpoints/2
            mid = (cluster_list[horiz_order[mid_points-1]].horiz_center() + cluster_list[horiz_order[mid_points]].horiz_center())/2
            horiz_l = horiz_order[:mid_points]
            horiz_r = horiz_order[mid_points:]
